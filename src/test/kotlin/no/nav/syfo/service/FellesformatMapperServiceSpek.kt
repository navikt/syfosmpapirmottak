...
class FellesformatMapperServiceSpek :
    FunSpec({
        ...
        context("MappingService ende-til-ende") {
            test("Realistisk case ende-til-ende") {
                val skanningMetadata =
                    skanningMetadataUnmarshaller.unmarshal(
                        StringReader(getFileAsString("src/test/resources/ocr-sykmelding.xml"))
                    ) as Skanningmetadata
                val sykmelder =
                    Sykmelder(
                        hprNummer = hprNummer,
                ...
                receivedSykmelding.sykmelding.kontaktMedPasient shouldBeEqualTo
                    KontaktMedPasient(null, null)
                receivedSykmelding.sykmelding.behandletTidspunkt shouldBeEqualTo
                    LocalDateTime.of(LocalDate.of(2019, Month.AUGUST, 15), LocalTime.NOON)
                receivedSykmelding.sykmelding.behandler shouldNotBeEqualTo null
                receivedSykmelding.sykmelding.avsenderSystem shouldBeEqualTo
                    AvsenderSystem("Papirsykmelding", journalpostId)
                receivedSykmelding.sykmelding.syketilfelleStartDato shouldBeEqualTo
                    LocalDate.of(2019, Month.AUGUST, 15)
                receivedSykmelding.sykmelding.signaturDato shouldBeEqualTo
                    LocalDateTime.of(LocalDate.of(2019, Month.AUGUST, 15), LocalTime.of(10, 0, 0))
            ...
            test("Minimal ocr-fil") {
                val skanningMetadata =
                    skanningMetadataUnmarshaller.unmarshal(
                        StringReader(
                            getFileAsString("src/test/resources/minimal-ocr-sykmelding.xml")
                        )
                    ) as Skanningmetadata
                val sykmelder =
                    Sykmelder(
                ...
                receivedSykmelding.sykmelding.medisinskVurdering.annenFraversArsak shouldBeEqualTo
                    null
                receivedSykmelding.sykmelding.skjermesForPasient shouldBeEqualTo false
                receivedSykmelding.sykmelding.arbeidsgiver shouldBeEqualTo
                    Arbeidsgiver(HarArbeidsgiver.INGEN_ARBEIDSGIVER, null, null, null)
                receivedSykmelding.sykmelding.perioder.size shouldBeEqualTo 1
                receivedSykmelding.sykmelding.perioder[0].aktivitetIkkeMulig shouldBeEqualTo
                    AktivitetIkkeMulig(null, null)
                receivedSykmelding.sykmelding.perioder[0].fom shouldBeEqualTo
                    LocalDate.of(2019, Month.AUGUST, 15)
                receivedSykmelding.sykmelding.perioder[0].tom shouldBeEqualTo
                ...
                receivedSykmelding.sykmelding.behandletTidspunkt shouldBeEqualTo
                    LocalDateTime.of(LocalDate.of(2019, Month.AUGUST, 15), LocalTime.NOON)
                receivedSykmelding.sykmelding.behandler shouldBeEqualTo
                    Behandler(
                        fornavn = "",
                        mellomnavn = null,
                        etternavn = "",
            ...
            test("Tilbakedatering settes riktig") {
                val skanningMetadata =
                    skanningMetadataUnmarshaller.unmarshal(
                        StringReader(
                            getFileAsString("src/test/resources/ocr-sykmelding-komplett.xml")
                        )
                    ) as Skanningmetadata
                val sykmelder =
                    Sykmelder(
                ...
                sykmelding.kontaktMedPasient shouldBeEqualTo
                    KontaktMedPasient(LocalDate.of(2000, 8, 10), "Han var syk i 2000 også.")
                sykmelding.behandletTidspunkt shouldBeEqualTo
                    LocalDateTime.of(LocalDate.of(2020, Month.MAY, 2), LocalTime.NOON)
            }
            ...
            test("Map with avventendeSykmelding uten innspillTilArbeidsgiver") {
                val skanningMetadata =
                    skanningMetadataUnmarshaller.unmarshal(
                        StringReader(
                            getFileAsString(
                                "src/test/resources/sykmelding-avventendesykmelding-ugyldig.xml"
                            )
                        )
                    ) as Skanningmetadata
                val sykmelder =
            ...
            test("map with avventendeSykmelding og innspillTilArbeidsgiver") {
                val skanningMetadata =
                    skanningMetadataUnmarshaller.unmarshal(
                        StringReader(
                            getFileAsString(
                                "src/test/resources/sykmelding-avventendesykmelding-gyldig.xml"
                            )
                        )
                    ) as Skanningmetadata
                val sykmelder =
        ...
        context("Hver del av MappingService mapper korrekt") {
            test("tilMedisinskVurdering") {
                ...
                val medisinskVurdering =
                    tilMedisinskVurdering(medisinskVurderingType, loggingMetadata)
            ...
            test(
                "tilMedisinskVurderingDiagnose bruker ICPC2 hvis system ikke er satt men koden finnes der og ikke i ICD10"
            ) {
                val diagnose =
                    toMedisinskVurderingDiagnose(
                        originalDiagnosekode = "L72",
            ...
            test(
                "tilMedisinskVurderingDiagnose bruker ICD10 hvis system ikke er satt men koden finnes der og ikke i ICPC2"
            ) {
                val diagnose =
                    toMedisinskVurderingDiagnose(
                        originalDiagnosekode = "S52.5",
            ...
            test(
                "tilMedisinskVurderingDiagnose feiler hvis system er ICD10 men koden finnes ikke der"
            ) {
                val func = {
                    toMedisinskVurderingDiagnose(
                        originalDiagnosekode = "L72",
            ...
            test(
                "tilMedisinskVurderingDiagnose feiler hvis system er ICPC2 men koden finnes ikke der"
            ) {
                val func = {
                    toMedisinskVurderingDiagnose(
                        originalDiagnosekode = "S52.5",
            ...
            test(
                "tilMedisinskVurderingDiagnose feiler hvis system er ICD10 men koden finnes kun i ICPC2"
            ) {
                val func = {
                    toMedisinskVurderingDiagnose(
            ...
            test(
                "diagnoseFraDiagnosekode ICPC-2, gyldig kode, gyldig diagnose, manglende kodeverk"
            ) {
                val system =
                    identifiserDiagnoseKodeverk(
                        diagnoseKode = "L72",
            ...
            test("tilArbeidsgiver ingen arbeidsgiver") {
                val arbeidsgiverType =
                    ArbeidsgiverType().apply { harArbeidsgiver = "Ingen arbeidsgiver" }
            ...
            test("tilPeriodeListe") {
                    ...
                    AktivitetType().apply {
                        ...
                        aktivitetIkkeMulig =
                            AktivitetIkkeMuligType().apply {
                                ...
                                periodeTOMDato = tom
                                medisinskeArsaker =
                                    MedisinskeArsakerType().apply { medArsakerBesk = "syk" }
                                arbeidsplassen =
                                    ArbeidsplassenType().apply { arbeidsplassenBesk = "miljø" }
                            }
                        behandlingsdager =
                ...
                periodeliste[0].aktivitetIkkeMulig.medisinskeArsaker.arsakskode.size shouldBeEqualTo
                    1
                ...
                periodeliste[2].avventendeSykmelding.innspillTilArbeidsgiver shouldBeEqualTo
                    "Innspill"
            ...
            test("tilUtdypendeOpplysninger") {
                val utdypendeOpplysningerType =
                    UtdypendeOpplysningerType().apply {
                        sykehistorie = "Er syk"
                ...
                utdypendeOpplysninger.spmGruppe
                    .first()
                    .spmSvar
                    ?.find { it.spmId == "6.2.1" }
                    ?.spmId shouldBeEqualTo "6.2.1"
                utdypendeOpplysninger.spmGruppe
                    .first()
                    .spmSvar
                    ?.find { it.spmId == "6.2.1" }
                    ?.spmTekst shouldBeEqualTo
                ...
                utdypendeOpplysninger.spmGruppe
                    ...
                    ?.restriksjonskode
                    ?.firstOrNull()
                    ?.dn shouldBeEqualTo "Informasjonen skal ikke vises arbeidsgiver"

                utdypendeOpplysninger.spmGruppe
                    .first()
                    .spmSvar
                    ?.find { it.spmId == "6.2.2" }
                    ?.spmId shouldBeEqualTo "6.2.2"
                utdypendeOpplysninger.spmGruppe
                    .first()
                    .spmSvar
                    ?.find { it.spmId == "6.2.2" }
                    ?.spmTekst shouldBeEqualTo "Hvordan påvirker sykdommen arbeidsevnen?"
                utdypendeOpplysninger.spmGruppe
                    .first()
                    .spmSvar
                    ?.find { it.spmId == "6.2.2" }
                ...
                utdypendeOpplysninger.spmGruppe
                    ...
                    .spmSvar
                    ?.find { it.spmId == "6.2.3" }
                    ?.spmId shouldBeEqualTo "6.2.3"
                utdypendeOpplysninger.spmGruppe
                    .first()
                    .spmSvar
                    ?.find { it.spmId == "6.2.3" }
                    ?.spmTekst shouldBeEqualTo "Har behandlingen frem til nå bedret arbeidsevnen?"
                utdypendeOpplysninger.spmGruppe
                    .first()
                    .spmSvar
                    ?.find { it.spmId == "6.2.3" }
            ...
            test("diagnosekodemapping små bokstaver") {
                ...
                val hoveddiagnose =
                    toMedisinskVurderingDiagnose(gyldigdiagnose, null, "foo Bar", loggingmetea)
            ...
            test("Ugyldig diagnosesystem-mapping") {
                ...
                val func = {
                    toMedisinskVurderingDiagnose(gyldigdiagnose, "IC", "foo Bar", loggingmetea)
                }
                func shouldThrow IllegalStateException::class
            }
