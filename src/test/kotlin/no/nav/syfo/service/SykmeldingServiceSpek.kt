...
class SykmeldingServiceSpek :
    FunSpec({
        ...
        beforeTest {
            ...
            coEvery { safDokumentClientMock.getDokument(any(), any(), any(), any(), any()) } returns
                null
        ...
        context("SykmeldingService ende-til-ende") {
            test("Send til smregistrering hvis SAF svarer 500 ved henting av skanningMetadata") {
                ...
                coEvery {
                    safDokumentClientMock.getDokument(any(), any(), any(), any(), any())
                } throws IOException()
                ...
                coEvery {
                    safDokumentClientMock.getDokument(
                        journalpostId,
                        dokumentInfoId,
                        any(),
                        any(),
