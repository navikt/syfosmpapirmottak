...
object BehandlingServiceSpek : Spek({
    ...
    describe("BehandlingService ende-til-ende") {
        it("Ende-til-ende journalpost med fnr") {
            ...
            runBlocking {
                behandlingService.handleJournalpost(journalfoeringEvent, loggingMetadata, sykmeldingId, syfoserviceProducerMock, sessionMock, "topic", kafkaproducerreceivedSykmelding, kuhrSarClientMock, dokArkivClientMock)
            }
            ...
            coVerify { sykmeldingServiceMock.behandleSykmelding(eq("123"), eq("fnr"), eq("aktorId"), null, datoOpprettet, any(), any(), any(), any(), any(), any(), any(), any()) }
        ...
        it("Ende-til-ende journalpost med aktorId") {
            ...
            runBlocking {
                behandlingService.handleJournalpost(journalfoeringEvent, loggingMetadata, sykmeldingId, syfoserviceProducerMock, sessionMock, "", kafkaproducerreceivedSykmelding, kuhrSarClientMock, dokArkivClientMock)
            }
        ...
        it("Sender null som fnr og aktørid hvis journalpost mangler brukerid") {
            ...
            coVerify { sykmeldingServiceMock.behandleSykmelding(eq("123"), null, null, null, datoOpprettet, any(), any(), any(), any(), any(), any(), any(), any()) }
        ...
        it("Sender aktørid==null hvis ikke kan hente aktørid fra aktørregister") {
            ...
            coVerify { sykmeldingServiceMock.behandleSykmelding(eq("123"), "fnr", null, null, datoOpprettet, any(), any(), any(), any(), any(), any(), any(), any()) }
        ...
        it("Sender fnr==null hvis ikke kan hente fnr fra aktørregister") {
            ...
            coVerify { sykmeldingServiceMock.behandleSykmelding(eq("123"), null, "aktorId", null, datoOpprettet, any(), any(), any(), any(), any(), any(), any(), any()) }
            coVerify { utenlandskSykmeldingServiceMock wasNot Called }
        }
        ...
        it("Behandler ikke meldinger med feil tema") {
            ...
            runBlocking {
                behandlingService.handleJournalpost(journalfoeringEventFeilTema, loggingMetadata, sykmeldingId, syfoserviceProducerMock, sessionMock, "", kafkaproducerreceivedSykmelding, kuhrSarClientMock, dokArkivClientMock)
            }
        ...
        it("Behandler ikke meldinger med feil mottakskanal") {
            ...
            runBlocking {
                behandlingService.handleJournalpost(journalfoeringEventFeilKanal, loggingMetadata, sykmeldingId, syfoserviceProducerMock, sessionMock, "", kafkaproducerreceivedSykmelding, kuhrSarClientMock, dokArkivClientMock)
            }
        ...
        it("Behandler ikke meldinger med feil hendelsestype") {
            ...
            runBlocking {
                behandlingService.handleJournalpost(journalfoeringEventFeilType, loggingMetadata, sykmeldingId, syfoserviceProducerMock, sessionMock, "", kafkaproducerreceivedSykmelding, kuhrSarClientMock, dokArkivClientMock)
            }
