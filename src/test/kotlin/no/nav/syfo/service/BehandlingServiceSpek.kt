    ...
    FunSpec({
        ...
        context("BehandlingService ende-til-ende") {
            ...
            test("Ende-til-ende journalpost med fnr ny skanningleverandør") {
                val journalfoeringEvent =
                    lagJournalfoeringEvent("MidlertidigJournalført", "SYM", "SKAN_IM")
            ...
            test("Feiler uten å opprette oppgave hvis PDL svarer med feilmelding") {
                ...
                coVerify {
                    listOf(sykmeldingServiceMock, utenlandskSykmeldingServiceMock) wasNot Called
                }
            }
            ...
            test("Behandler ikke meldinger med feil tema") {
                val journalfoeringEventFeilTema =
                    lagJournalfoeringEvent("MidlertidigJournalført", "FEIL_TEMA", "SKAN_NETS")
            ...
            test("Behandler ikke meldinger med feil mottakskanal") {
                val journalfoeringEventFeilKanal =
                    lagJournalfoeringEvent("MidlertidigJournalført", "SYM", "FEIL_KANAL")
            ...
            test("Behandler ikke meldinger med feil hendelsestype") {
                val journalfoeringEventFeilType =
                    lagJournalfoeringEvent("Ferdigstilt", "SYM", "SKAN_NETS")
