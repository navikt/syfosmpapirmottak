...
suspend fun handleOk(
    ...
    dokArkivClient.oppdaterOgFerdigstillJournalpost(journalpostId = journalpostid, sykmeldingId = sykmeldingId, hprnummer = receivedSykmelding.sykmelding.behandler.hpr!!, loggingMeta = loggingMeta)
