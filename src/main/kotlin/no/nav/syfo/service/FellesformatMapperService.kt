        ...
        any.add(
            XMLMsgHead().apply {
                msgInfo = XMLMsgInfo().apply {
                    ...
                    genDate = velgRiktigKontaktOgSignaturDato(skanningmetadata.sykemeldinger.kontaktMedPasient?.behandletDato, tilPeriodeListe(skanningmetadata.sykemeldinger.aktivitet)).toString()
                    msgId = sykmeldingId
                    ack = XMLCS().apply {
                        dn = "Ja"
                        v = "J"
