...
val PAPIRSM_MAPPET_OK: Counter = Counter.build()
    .namespace(NAMESPACE)
    .name("papirsykmelding_mappet_ok_count")
    .help("Antall sykmeldinger vi klarte å mappe uten feil")
    .register()

val PAPIRSM_MAPPING_FEILET: Counter = Counter.build()
    .namespace(NAMESPACE)
    .name("papirsykmelding_mapping_feilet_count")
    .help("Antall sykmeldinger vi ikke klarte å mappe")
    .register()
