...
data class ResponseData(val hentPerson: HentPerson?, val hentIdenter: HentIdenter?)

data class HentIdenter(val identer: List<PdlIdent>)
...
data class HentPerson(val navn: List<Navn>?, val adressebeskyttelse: List<Adressebeskyttelse>?)
